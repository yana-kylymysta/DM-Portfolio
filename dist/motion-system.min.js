...
(function () {
  ...
  // Global onEnter: marks dataset.animated='true' the instant any ScrollTrigger
  // fires, so the safety-net IO below skips elements GSAP is already handling.
  // Kills the fast-scroll race that produced the About "double-fire".
  ...
  function installRevealSafetyNet() {
    ...
    // -200px (was -40px): IO fires well INSIDE viewport, long after
    // GSAP's 'top 75–92%' triggers. Combined with the global onEnter
    // above, this makes the safety-net a pure rescuer — it can no
    // longer race with a live GSAP tween mid-animation.
